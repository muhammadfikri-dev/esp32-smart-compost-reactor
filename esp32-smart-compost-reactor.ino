/**
 * =========================================================================================
 * Project     : ESP32 Industrial Compost Aeration & Thermal Decomposition Profiler
 * Platform    : ESP32 (Dual-Core Xtensa LX6 / FreeRTOS)
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Compost facility automation system monitoring 4-probe PT100 temperature gradients (thermophilic stage 55-65°C), moisture levels, and driving forced-air blowers.
 * =========================================================================================
 */
...
void TaskTelemetryBroadcaster(void *pvParameters) {
    ...
    for (;;) {
        if (xSemaphoreTake(g_telemetryMutex, pdMS_TO_TICKS(20)) == pdTRUE) {
            ...
            doc["system"] = "esp32-smart-compost-reactor";
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" ESP32 Industrial Compost Aeration & Thermal Decomposition Profiler"));
